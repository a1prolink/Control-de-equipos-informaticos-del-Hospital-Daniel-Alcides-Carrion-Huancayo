...
if (!empty($_POST))
{
	...
	else
	{
        ...
        if ($result > 0) {
        	$alert = '<p class="msg_error">Usuario o correo ya existe.</p>';
        }
        else
        {
        	$query_insert = mysqli_query($conection, "INSERT INTO usuarios(nombre,correo,usuario,clave,rol) VALUES('$nombre','$email','$user','$clave','$rol')");
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/user_form_style.css">
