...
<body>
    <?php
        ...
        $query_empresa = mysqli_query($conection,"SELECT * FROM configuración");
        ...
        $query_dash = mysqli_query($conection,"CALL dataDashboards();");
             ...
             <div class="dashboard">
                ...
                <a href="lista_usuario.php">
                	...
                	<p>
                		...
                		<span><?= $data_dash['usuarios'] ?? '0'; ?></span>
                	</p>
                </a>
                    <?php } ?>
                <a href="lista_clientes.php">
                	...
                	<p>
                        ...
                        <span><?= $data_dash['clientes'] ?? '0'; ?></span>
                	</p>
                </a>
                <?php
                    if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2)
                ...
                <a href="lista_proveedor.php">
                	...
                	<p>
                		...
                		<span><?= $data_dash['proveedores'] ?? '0'; ?></span>
                	</p>
                </a>
                <?php } ?>
                 ...
                 <div class="containerDataUser">
                 	...
                 	<div class="divDataUser">
                       ...
                       <form action="" method="post" name="frmChangePass" id="frmChangePass">
                           ...
                           <div>
                               <input class="newPass" type="password" name="txtPassConfirm" id="txtPassConfirm" placeholder=" Confirma Contraseña" required>
                           </div>
                 ...
                 <div class="containerDataEmpresa">
                    ...
                    <form action="" method="post" name="frmEmpresa" id="frmEmpresa">
                    	<input type="hidden" name="action" value="updateDataEmpresa">
                    	   ...
                    	   <div>
                    	   	  <label>Teléfono:</label><input type="text" name="txtTelEmpresa" id="txtTelEmpresa" placeholder="Numero de Teléfono" value="<?= $telEmpresa; ?>" required>
                    	   </div>
                    	   <div>
                    	   	  <label>Correo electronico:</label><input type="email" name="txtEmailEmpresa" id="txtEmailEmpresa" placeholder="Correo electrónico" value="<?= $emailEmpresa; ?>" required>
                    	   </div>
                    	   <div>
